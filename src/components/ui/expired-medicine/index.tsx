...
import { expiredMedicineData, expiredMedicineHeader } from "@/_shared/data";
...
const ExpiredMedicineComponent = () => {
  ...
  return (
    <section className="">
      <h1 className=" font-semibold text-2xl">Expired Medicines</h1>
      ...
      <Card className="p-4 rounded-md">
        <StaffsCustomTable
          headers={expiredMedicineHeader}
          data={expiredMedicineData}
        />
      </Card>
    </section>
  );
...
export default ExpiredMedicineComponent;
