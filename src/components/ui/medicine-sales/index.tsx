...
import { medicineSaleData, medicineSaleHeader } from "@/_shared/data";
...
const MedicineSalesComponent = () => {
  ...
  return (
    <section className="">
      <h1 className=" font-semibold text-2xl">Retail Medicine Sales</h1>
...
export default MedicineSalesComponent;
