...
const MedicineCategoriesComponent = () => {
  ...
  return (
    <section className="">
      <h1 className=" font-semibold text-2xl">Medicine Categories</h1>
      ...
      <Card className="p-4 rounded-md">
        <StaffsCustomTable
          headers={medicineCategoriesHeader}
...
export default MedicineCategoriesComponent;
