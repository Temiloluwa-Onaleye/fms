...
import {
  emergencyInventoryData,
  emergencyInventoryHeader,
} from "@/_shared/data";
...
const EmergencyInventoryComponent = () => {
  ...
  return (
    <section className="">
      <h1 className=" font-semibold text-2xl">Emergency Inventory</h1>
      ...
      <Card className="p-4 rounded-md">
        <StaffsCustomTable
          headers={emergencyInventoryHeader}
          data={emergencyInventoryData}
        />
      </Card>
    </section>
  );
...
export default EmergencyInventoryComponent;
